...
class TestPartyAPI(unittest.TestCase):
    ...
    def test_get_Code_From_Name(self):
        ...
        data = {"access_token": "BQLvq6", "token_type": "Bearer", "expires_in": 3600, "refresh_token": "ZaT9sI4IDuKJoPRp_Rvp8OsVkoDMQ", "scope": "null", "expires_at": 2}
    ...
    def test_get_Error_From_Improper_Name(self):
        ...
        header = { 'Content-Type': 'application/json' }
        data = {"access_token": "", "token_type": "Bearer", "expires_in": 3600, "refresh_token": "", "scope": "null", "expires_at": 2}
